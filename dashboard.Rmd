...
mytext <- paste(
    ...
    "Confirmed Cases: ", round(world_spdf_join@data$confirmed, 2), "M", "<br/>", 
...
mytext <- paste(
    "Country: ", world_spdf_join@data$NAME,"<br/>", 
    "Deaths: ", round(world_spdf_join@data$deaths, 2), "K", "<br/>", 
...
The **Johns Hopkins University Center for Systems Science and Engineering (JHU CCSE) Coronavirus repository** 
